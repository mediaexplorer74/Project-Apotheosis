...
enum Opcode : int16_t {
    ...
    CompareOnFlags64,
    CompareOnFlagsFloat,
    CompareOnFlagsDouble,
    CompareConditionallyOnFlags32,
    CompareConditionallyOnFlags64,
    CompareConditionallyOnFlagsFloat,
    CompareConditionallyOnFlagsDouble,
    Branch8,
    Branch32,
    Branch64,
    BranchTest8,
...
static const unsigned numOpcodes = 478;
