...
// Apotheosis: memory pressure release (OOM prevention). harness calls this
// on UWP high-memory events. critical: 1=critical, 0=gentle. Flushes caches,
// back-forward page cache, JSC GC, font cache.
